...
const SystemChat = () => {
  ...
  const chatUsers: ChatUser[] = [
    { id: 1, name: 'FireStorm Admin', type: 'admin', status: 'online', lastMessage: 'System admin, we need approval...', unreadCount: 1, organization: 'FireStorm' },
    { id: 2, name: 'PlayerOne', type: 'user', status: 'online', lastMessage: 'Payment gateway issue...', unreadCount: 1 },
    { id: 3, name: 'Lightning ORG Admin', type: 'admin', status: 'online', lastMessage: 'Tournament schedule', unreadCount: 0, organization: 'Lightning' },
    { id: 4, name: 'GamerPro', type: 'user', status: 'offline', lastMessage: 'Account verification', unreadCount: 0 },
    { id: 5, name: 'Thunder Admin', type: 'admin', status: 'online', lastMessage: 'Rule clarification needed', unreadCount: 2, organization: 'Thunder' },
    { id: 6, name: 'SquadLeader', type: 'user', status: 'online', lastMessage: 'Team registration help', unreadCount: 0 }
  ];
  ...
  const handleSendMessage = () => {
    if (newMessage.trim() && selectedUser) {
      ...
      setTimeout(() => {
        const responses = [
          "Thank you for the guidance, System Admin!",
          "Understood, I'll implement that right away.",
          "Perfect, that clarifies everything!",
          "Got it, proceeding as advised."
        ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                {user.organization && (
                  <p className="text-xs text-gaming-gold">{user.organization} ORG</p>
                )}
                {user.lastMessage && (
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="p-0">
            <Tabs defaultValue="all" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mx-4 mb-4 text-xs">
              ...
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {selectedUser.organization && (
                    <Badge variant="outline" className="text-xs border-gaming-gold text-gaming-gold">
                      {selectedUser.organization}
                    </Badge>
                  )}
